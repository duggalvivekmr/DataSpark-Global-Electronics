...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/sales_full_cleaned_fixed.csv'
INTO TABLE sales_full
...
SET `Delivery Date` = NULLIF(@delivery_date, '');
SELECT COUNT(*) FROM sales_full;
SELECT * FROM sales_full LIMIT 5;
